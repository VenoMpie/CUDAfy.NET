...
namespace Cudafy
{
    ...
    public class CompilerHelper
    {
        ...
        public static CompileProperties Create(ePlatform platform = ePlatform.Auto, eArchitecture arch = eArchitecture.sm_50, eCudafyCompileMode mode = eCudafyCompileMode.Default, string workingDir = null, bool debugInfo = false)
        {
            ...
            if (language == eLanguage.Cuda)
            {
                ...
                tp.Architecture = (arch == eArchitecture.Unknown) ? eArchitecture.sm_50 : arch;
